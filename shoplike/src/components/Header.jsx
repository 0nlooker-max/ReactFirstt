        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center">
            <div className="flex-shrink-0">
              <Link to="/" className="text-2xl font-bold text-white hover:text-orange-100 transition-colors duration-200">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button 
              ...
              className="relative text-white hover:text-orange-100 transition-colors duration-200"
            >
