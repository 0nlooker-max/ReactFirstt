...
export const CheckoutPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Note: Quantity deduction is now handled in the checkout function in CartContext.jsx
      ...
      // Perform checkout logic (creates order in Firestore)
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              >
                {isProcessing
                  ? "Processing Payment..."
                  : `Complete Order - $${(getTotalPrice() * 1.08).toFixed(2)}`}
              </button>
            </form>
          </div>
        </div>
